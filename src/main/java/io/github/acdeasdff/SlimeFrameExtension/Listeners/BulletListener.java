...
//            logger.log(Level.WARNING, String.valueOf(Damage));
        ...
        }else {return new double[]{Damage, 0, 0};}
    ...
    public static int getArmorFromArmor(ItemStack armor){
        if (armor == null){return 0;}
            ...
            return switch (armor.getType()) {
                case DIAMOND_HELMET, DIAMOND_BOOTS, NETHERITE_HELMET, NETHERITE_BOOTS, GOLDEN_LEGGINGS,LEATHER_CHESTPLATE,LEATHER_HORSE_ARMOR-> 3;
